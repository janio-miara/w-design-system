...
const SidebarLogo = ({ sidebarOpen, setSidebarOpen, logoOpacity, logoUrl }) => {
    return (React.createElement(SidebarLogoContainer, { logoUrl: logoUrl, logoOpacity: logoOpacity, sidebarOpen: sidebarOpen },

...
import { SizeBasic } from '../Types/index';
...
export const WrapperTextArea = styled.textarea<ILabel>`
  ...
  color: ${({ validate }) => (validate ? theme.colors.shade70 : theme.colors.red40)};
  ...
  &:focus {
    ...
    color: ${({ validate }) => (validate ? theme.colors.shade70 : theme.colors.red30)};

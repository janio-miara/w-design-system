...
const meta: Meta<typeof DocumentNumberInput> = {
  title: 'Components/DocumentNumberInput',
  component: DocumentNumberInput,
  tags: ['autodocs'],
  argTypes: {
...
export default meta
type Story = StoryObj<typeof DocumentNumberInput>
...
export const Default: StoryObj<typeof DocumentNumberInput> = {
  render: args => <ComponentWrapper {...args} />,
}

export const Disabled: StoryObj<typeof DocumentNumberInput> = {
  render: args => <ComponentWrapper {...args} placeholder="Disabled" label="Disabled" disabled />,
}

export const DisabledWithIcon: StoryObj<typeof DocumentNumberInput> = {
  render: args => (
    <ComponentWrapper
      {...args}
